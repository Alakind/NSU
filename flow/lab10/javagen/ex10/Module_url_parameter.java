...
final class Module_url_parameter {
	public static Struct g_allUrlParameters;
	public static void init() {
		g_allUrlParameters=Module_url_parameter.f_getAllUrlParameters();
	}
	...
	public static final boolean f_isUrlParameterTrue(String aname) {
			final Struct l3_$2 = Module_tree.f_lookupTree(Module_url_parameter.g_allUrlParameters, aname);
