...
final class Module_tree {
	public static final Object f_foldRTree(Struct atree, Object aacc, Func3<Object,Object, Object, Object> af) {
		TAIL_CALL: for(;;) {
			...
			case 112/*TreeNode*/: {
				...
				final Object l12_acc1 = Module_tree.f_foldRTree(l10_right, aacc, af);
				final Object l13_acc2 = af.invoke(l7_k, l8_v, l12_acc1);
				{
					final Struct l14___tmp = l9_left;
	...
	public static final boolean f_isEmptyTree(Struct at) {
			return ((Struct)at).getTypeId() == 111;
		}
	...
	public static final Struct_TreeNode f_makeTree1(Object akey, Object avalue) {
			return (new Struct_TreeNode(akey, avalue, ((Struct)SingletonStructs.str_TreeEmpty), ((Struct)SingletonStructs.str_TreeEmpty), 1));
		}
	public static final Struct f_mapTree(Struct atree, Func1<Object,Object> af) {
			Struct l0__tmp = atree;
			switch (l0__tmp.getTypeId()) {
			case 111/*TreeEmpty*/: {
				return ((Struct)SingletonStructs.str_TreeEmpty);
			...
			case 112/*TreeNode*/: {
				...
				final Struct l10_right = l1__tmp.f_right;
				final int l11_depth = l1__tmp.f_depth;
				return (new Struct_TreeNode(l7_k, af.invoke(l8_v), Module_tree.f_mapTree(l9_left, af), Module_tree.f_mapTree(l10_right, af), l11_depth));
			}
			default:
				throw new RuntimeException("Unexpected struct in switch: "+l0__tmp.getTypeName());
			}
		}
	public static final Struct f_mergeTreeCustom(Struct at1, Struct at2, Func3<Object,Object, Object, Object> afn) {
			...
			final Func3<Struct,Object, Object, Struct> l1_$0 = (Func3<Struct, Object, Object, Struct>)(Object ak, Object av, Struct aacc) -> {
				final Struct l4_$3 = Module_tree.f_lookupTree(aacc, ak);
				final Func1<Object,Object> l5_$2 = (Func1<Object, Object>)(Object av2) -> {
					return l2_fn.invoke(ak, av, av2);
				};
				final Object l6_vv = Module_maybe.f_eitherMap(l4_$3, l5_$2, av);
				return Module_tree.f_setTree(aacc, ak, l6_vv);
			};
